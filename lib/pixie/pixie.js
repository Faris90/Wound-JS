(function() {
  ...
  TopBar.prototype.showAbout = function() { // NS
    ...
    var d = new Dialog(_('About Wound JS'), Dialog.content(
      el('article', [
        el('h1', ['Wound JS']),
        el('p', ['An unofficial rewrite of ', link('Scratch', 'https://scratch.mit.edu'), ' in JavaScript, based off Pixie by ', link('Nathan Dinsmore', 'https://github.com/nathan'), '.']),
        el('p', ['Wound JS aims to provide an application nearly identical to the current, Flash-based Scratch editor and player using only web technologies. The source code is ', link('available on GitHub', 'https://github.com/csf30816/Wound-JS'), '.']),
        cl('ul', 'links', [
          el('li', [link('Issues (coming soon)', '')]),
          el('li', [link('Contributors', 'https://github.com/csf30816/Wound-JS/graphs/contributors')])
        ])
      ]),
  ...
  SpritePanel.prototype.newFromLibrary = function() {
    this.editor.addSprite(this.emptySprite()
      .addCostume(new Costume('costume1', 'c68e7b211672862001dd4fce12129813.png', 94, 108, 2))
      .addCostume(new Costume('costume2', 'c68e7b211672862001dd4fce12129813.png', 94, 108, 2)));
  };
